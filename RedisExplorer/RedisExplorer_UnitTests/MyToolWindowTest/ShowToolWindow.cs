...
namespace RedisExplorer_UnitTests.MyToolWindowTest
{
	...
	public class ShowToolWindowTest
	{
		...
		{
			IVsPackage package = new RedisExplorerPackage() as IVsPackage;
			...
			MethodInfo method = typeof(RedisExplorerPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
